...
print("the bigger room can not arrive on time, so it will be two guests could be invited")
someone = guest.pop()
print("sorry I can not have dinner with you," + someone)
someone = guest.pop()
print("sorry I can not have dinner with you," + someone)
someone = guest.pop()
print("sorry I can not have dinner with you," + someone)
...
someone = guest.pop()
print("sorry I can not have dinner with you," + someone)
print("I will have dinner with you," + guest[0])
print("I will have dinner with you," + guest[1])
del(guest[1])
del(guest[0])
print(guest)